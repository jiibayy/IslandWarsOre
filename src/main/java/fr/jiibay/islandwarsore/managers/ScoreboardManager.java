...
import fr.jiibay.islandwarsore.tasks.EndTask;
import fr.jiibay.islandwarsore.tasks.PlayingTask;
...
public class ScoreboardManager {
    ...
    public void scoreboardPlaying(FastBoard board){
        ...
        String [] lines = {
                "§h",
                ChatColor.GREEN + "➥ Joueurs : " + ChatColor.AQUA + Bukkit.getOnlinePlayers().size(),
                ChatColor.GREEN + "➥ Chronomètre : " + ChatColor.AQUA + new SimpleDateFormat("mm:ss").format(PlayingTask.timer * 1000),
                "§c",
                ChatColor.GREEN + "➥ Status : " + ChatColor.AQUA + MainIWO.getInstance().getStat(),
                ChatColor.GREEN + "➥ Ping : " + ChatColor.AQUA + playersPing + "ms",
    ...
    public void scoreboardEnd(FastBoard board){
        ...
        String [] lines = {
                "§h",
                ChatColor.GREEN + "➥ Joueurs : " + ChatColor.AQUA + Bukkit.getOnlinePlayers().size(),
                ChatColor.GREEN + "➥ Chronomètre : " + ChatColor.AQUA + new SimpleDateFormat("mm:ss").format(EndTask.timer * 1000),
                "§c",
                ChatColor.GREEN + "➥ Status : " + ChatColor.AQUA + MainIWO.getInstance().getStat(),
                ChatColor.GREEN + "➥ Ping : " + ChatColor.AQUA + playersPing + "ms",
                ChatColor.GREEN + "➥ Equipe : " + ChatColor.AQUA + playerProfile.getTeam().getName(),
                ChatColor.GREEN + "➥ Kills : " + ChatColor.AQUA + playerProfile.getKill(),
                ChatColor.GREEN + "➥ Points Rouge : " + ChatColor.RED + Team.RED.getPoints(),
                ChatColor.GREEN + "➥ Points Bleu : " + ChatColor.BLUE + Team.BLUE.getPoints(),
                "§d",
                ChatColor.GOLD + "play.h-party.fr",
        };
