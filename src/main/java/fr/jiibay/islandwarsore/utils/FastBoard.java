package fr.jiibay.islandwarsore.utils;
...
import static fr.jiibay.islandwarsore.utils.FastReflection.nmsOptionalClass;
...
public class FastBoard {
    ...
    static {
        try {
            if (nmsOptionalClass("ScoreboardServer$Action").isPresent()) {
                VERSION_TYPE = VersionType.V1_13;
            } else if (nmsOptionalClass("IScoreboardCriteria$EnumScoreboardHealthDisplay").isPresent()) {
